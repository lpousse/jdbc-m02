...
public class TestInsertion {
	...
	public static void main(String[] args) {
		try {
			...
			fidao.insert(new Fournisseur(0, "Leroy Merlin"));
			
			ArticleIdao aidao = new ArticleIdao();
			aidao.insert(new Article(0, "G01", "Peinture blanche 1L", 12.5f, 4));
			
			BonIdao bidao = new BonIdao();
			bidao.insert(new Bon(0, 7, Timestamp.valueOf(LocalDateTime.now()), 1, 4));
			
			CompoIdao cidao = new CompoIdao();
			cidao.insert(new Compo(0, 2, 7, 3));
		}
		catch(Exception ex) {
